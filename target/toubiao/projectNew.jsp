...
<head>
	...
	<script src="${pageContext.request.contextPath}/js/projectNew.js" type="text/javascript" charset="utf-8"></script>
...
<body class="container">
	<div class="row">
		<div class="col-lg-12 col-md-12 ">
			<div > 
				<h3>项目名称: 河南省豫西森林防火通信系统建设工程 可行性研究报告</h3>
			</div>
		</div>
	</div>		
	<section class="info">
		...
		<div class="infoBody" id="detail-info">
			<jsp:include page="detailPart.jsp"></jsp:include>
		</div>
	
		<div id="detail-edit" class="editBody">
				<jsp:include page="detailEditPart.jsp"></jsp:include>
		</div>	
	...
	<section class="info" >
			...
			<div class="row">
				<div class="col-lg-12 col-md-12 ">
					<h3>项目描述&nbsp;&nbsp;
						<small>
							项目背景&nbsp;&nbsp;|&nbsp;&nbsp;工程规模&nbsp;&nbsp;|&nbsp;&nbsp;人员分工
							<a href="#" style="margin-top: 0px;margin-left: 10px;" id="description-edit-btn">
								<span class="glyphicon glyphicon-pencil"  aria-hidden="true"></span>
							</a>
						</small>
					</h3>
		...
		<div class="infoBody" id="description-part">
			<div class="row" >
				<div class="col-lg-12 col-md-12 ">
					<div class="description" id="description">
						<div class="panel panel-default">
							<div class="panel-body" id="description-old-text">
								${project.description}	
							</div>
						</div>
					</div>
	...
	<section class="info" id="reward-section">
		<div class="infoHead">
			<div class="row">
				<div class="col-lg-12 col-md-12 ">
					<h3>获奖情况&nbsp;&nbsp;
	...
	<section class="info" id="photo-section">
		<div class="infoHead">
			<div class="row">
				<div class="col-lg-12 col-md-12 ">
					<h3>电子照片&nbsp;&nbsp;
