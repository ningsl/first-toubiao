// EasyUI tree 全选和反选
	...
	$(function() {
		//获得初始id
		var designerIds=$("#form-project-designerIds",window.parent.document).val();
		...
		//加载designer Tree
		var treeUrl=contextPath+"/department/treeWithDesigner?checkedIds="+designerIds;
		console.log(treeUrl);
		...
		$("#ok").on("click",function(){
			...
			var designerNames=new Array();
			var designerPhones=new Array();
			$.each(rows, function() {
				console.log(this);
				designerIds.push(this.id);
				designerNames.push(this.name);
				designerPhones.push(this.phone)
			});
			
			$("#form-project-designerIds",window.parent.document).val(designerIds.join(";"));
			$("#form-project-designerNames",window.parent.document).val(designerNames.join(";"));
			$("#form-project-designerPhones",window.parent.document).val(designerPhones.join(";"));
