...
public class DocxUtils {
	 ...
	 */
	static public void addTrByIndex(Tbl tbl, int index) {
	 ...
	 */
	public static void addTrByIndex(Tbl tbl, int index, STVerticalJc vAlign,
	...
	/**
	 * @Description：删除元素，未严格验证
	 * @param theList  ((ContentAccessor)(rmObj.parent()).getContent()
	 * @param rmObj
	 * @return
	 */
	public  static boolean remove(List<Object> theList, Object rmObj) 	{
		// Can't just remove the object from the parent,
		// since in the parent, it may be wrapped in a JAXBElement
		int i=0;
		for (Object ox : theList) {
			System.out.println("+++++++++++++   "+i+"    ++++++++++");
			System.out.println(XmlUtils.marshaltoString(ox));
			if (XmlUtils.unwrap(ox).equals(rmObj)) {
				System.out.println("ox==rmObj");
	...
	/**
	 * @Description：删除元素，未严格验证
	 * @param parent child.getParent()
	 * @param child
	 * @return
	 */
	public static boolean remove(Object parent, Object child) 	{
		// Can't just remove the object from the parent,
		// since in the parent, it may be wrapped in a JAXBElement
		int i=0;
		...
		for (Object ox : theList) {
			System.out.println("+++++++++++++   "+i+"    ++++++++++");
			System.out.println(XmlUtils.marshaltoString(ox));
			if (XmlUtils.unwrap(ox).equals(child)) {
				System.out.println("ox==bm");
				return theList.remove(ox);
			}
			i++;
		}
